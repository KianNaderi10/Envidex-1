        ...
        <div className="grid grid-cols-3 gap-2">
          {allSpecies
            ...
            .map((species) => (
              <Card
                key={species.id}
                className="aspect-square flex flex-col items-center justify-center gap-1.5 border-border/30 bg-card/30 p-2"
              >
                <div className="h-10 w-10 rounded-xl bg-muted/50 flex items-center justify-center">
                  <Lock className="h-4 w-4 text-muted-foreground/50" />
                </div>
                <span className="text-[9px] text-muted-foreground/50 text-center leading-tight">???</span>
              </Card>
            ))}
        </div>
      </div>
